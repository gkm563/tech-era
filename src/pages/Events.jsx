    ...
    <div>
      <div className="evl-hero">
        ...
        <div style={{display:"flex",gap:14,flexWrap:"wrap"}}>
          {[{val:`${events.length}`,lbl:"Total Events"},{val:"3+",lbl:"Speakers"},{val:"2K+",lbl:"Community"},{val:"10+",lbl:"Partners"}].map(({val,lbl})=>(
      ...
      <div className="ev-footer-inner">
        <div className="ev-footer-grid">
          ...
          <div>
            ...
            {["📧 techeraa151@gmail.com","📞 +91 9310526618","📍 Hybrid, India"].map(item=>(
